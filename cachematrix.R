## The goal for this assignment is to write a pair of functions that cache the
## inverse of a matrix.
...
## 2) cachesolve: The following function computes the inverse of the special "matrix" returned by 
